...
Original file is located at
    https://colab.research.google.com/drive/1FhNU8kUSUyGrmNkpdh6du9Gi3GkZuuY9
"""
...
print(a.dtype) #int32 -> float32
print(b.dtype)
# tensorflow에서는 float32가 기본 자료형
...
num_arr = np.array([10., 10., 10.]) # numpy array
...
# tensor 변환 - constant 함수에 2차원 배열 입력
...
# tensor 변환 - stack 함수로 1차원 배열을 위아래로 쌓기
mat2 = tf.stack([vec1, vec2]) # stack -> 대괄호 중요!
...
# tensor 변환 - constant 함수에 3차원 배열 입력
...
# tensor 변환 - stack 함수로 2차원 배열을 위아래로 쌓기
...
tensor1 = tf.reshape(tensor, [3,8]) # shape(24,) -> shape(3,8)
print(tensor1)

tensor2 = tf.reshape(tensor1, [-1,4]) # -1 : 어떤 값이든 상관 없음을 의미한다. -> 두번째 값을 4로 만들고 첫번째 값은 이에 맞게 자동으로 변경됨.
print(tensor2)

tensor3 = tf.reshape(tensor2, [-1]) # 1차원 벡터로 변환
print(tensor3)

tensor4 = tf.reshape(tensor, [-1, 3, 4]) # rank-3 tensor 변환
tensor4
...
print("name: ", tensor_var1.name)
print("shape: ", tensor_var1.shape)
print("dtype: ", tensor_var1.dtype)
print("array: ", tensor_var1.numpy())
...
tensor_var2 = tf.Variable(tensor2, name='New Name') # 변수 이름 변경
print(tensor_var2)
